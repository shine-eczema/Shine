...
def account():
    ...
    if logged_in_username:
        return render_template('account.html', signup_message=signup_message, login_message=login_message, official_username=logged_in_username)
    else:
...
def store_account_info(first_name, last_name, email, username, password):
    ...
    account_info = f"{first_name},{last_name},{email},{username},{password},{signup_date}\n"
